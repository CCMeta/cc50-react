import { Divider, Stack, Box, FormGroup, FormControlLabel, Checkbox, TextField, Select, 
    MenuItem, Switch, FormControl, RadioGroup, Radio, Chip  } from '@mui/material';
...
export default function SetSIM() {
  ...
  return useObserver(()=>(
    <Stack>
        <Divider textAlign="right"><Chip label="SIM" /></Divider>
        ...
        <Divider textAlign="right" sx={{marginTop: "15px", marginBottom: "15px"}}><Chip label="APN" /></Divider>
