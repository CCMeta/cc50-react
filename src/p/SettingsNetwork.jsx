import { Divider, Stack, Box, FormGroup, FormControlLabel, Checkbox, TextField, Select, 
    MenuItem, Switch, Button, FormControl, RadioGroup, Radio  } from '@mui/material';
  ...
  function TextField1(props) {
    return (
        <TextField
          ...
          sx={{ padding: "2px", width: "45px", height: "40px", color: "#fff",webkitAppearance: "none", fontSize: {xs:"5px", md:"1rem"},
